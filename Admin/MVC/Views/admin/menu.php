...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
  ...
  <div class="sidebar-brand-text mx-3"><sup>Pet</sup></div>
</a>
...
<li class="nav-item">
  <a class="nav-link" href="?mod=sanpham">
    ...
    <span>Quản lý Thú cưng</span></a>
</li>

<li class="nav-item">
  <a class="nav-link" href="?mod=loaisanpham">
    <i class="fas fa-dog"></i>
    <span>Quản lý Loại thú cưng</span></a>
</li>

<li class="nav-item">
  <a class="nav-link" href="?mod=hoadon">
    <i class="fas fa-fw fa-table"></i>
    <span>Xét duyệt hợp đồng</span></a>
</li>

<li class="nav-item">
  <a class="nav-link" href="?mod=danhmuc">
    <i class="fas fa-fw fa-table"></i>
    <span>Quản lý danh mục thú cưng</span></a>
</li>
<?php if (isset($_SESSION['isLogin_Admin']) && $_SESSION['isLogin_Admin'] == true) { ?>
<li class="nav-item">
